...
const file_proto_task_proto_rawDesc = "" +
	...
	"\n" +
	"SendResult\x12\x12.task.TaskResponse\x1a\v.task.EmptyB\x0fZ\r/proto/taskpbb\x06proto3"
...
var file_proto_task_proto_depIdxs = []int32{
	2, // 0: task.TaskService.GetTask:input_type -> task.Empty
	1, // 1: task.TaskService.SendResult:input_type -> task.TaskResponse
	0, // 2: task.TaskService.GetTask:output_type -> task.TaskRequest
	2, // 3: task.TaskService.SendResult:output_type -> task.Empty
