...
type TaskServiceClient interface {
	...
	SendResult(ctx context.Context, in *TaskResponse, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *taskServiceClient) GetTask(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TaskRequest, error) {
...
func (c *taskServiceClient) SendResult(ctx context.Context, in *TaskResponse, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type TaskServiceServer interface {
	...
	SendResult(context.Context, *TaskResponse) (*Empty, error)
...
func (UnimplementedTaskServiceServer) GetTask(context.Context, *Empty) (*TaskRequest, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTask not implemented")
}
func (UnimplementedTaskServiceServer) SendResult(context.Context, *TaskResponse) (*Empty, error) {
...
func _TaskService_SendResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).SendResult(ctx, req.(*TaskResponse))
	}
	return interceptor(ctx, in, info, handler)
}
